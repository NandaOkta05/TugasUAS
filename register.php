                        ...
                        <div class="card login-form mb-0">
                            <div class="card-body pt-5">
                                ...
                                <?php if (isset($_GET["error"])) : ?>
                                    <p style="color: red;">Email sudah terdaftar. Silakan login.</p>
                                <?php endif; ?>
                                <a class="text-center" href="index.php">
                                    <h4>Register To Nomina</h4>
                                </a>

                                <form class="mt-5 mb-5 login-input" method="POST" action="proses_register.php">
